...
import com.moko.lw013sb.databinding.Lw013DialogPasswordBinding;
import com.moko.lw013sb.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw013DialogPasswordBinding> {
    ...
    @Override
    protected Lw013DialogPasswordBinding getViewBind() {
        return Lw013DialogPasswordBinding.inflate(getLayoutInflater());
    }
