...
import com.moko.lw013sb.databinding.Lw013DialogLoadingMessageBinding;
import com.moko.lw013sb.view.ProgressDrawable;

import androidx.annotation.StringRes;
import androidx.core.content.ContextCompat;

public class LoadingMessageDialog extends com.moko.lw013sb.dialog.MokoBaseDialog<Lw013DialogLoadingMessageBinding> {
    ...
    @Override
    protected Lw013DialogLoadingMessageBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw013DialogLoadingMessageBinding.inflate(inflater, container, false);
    }

    @Override
    protected void onCreateView() {
        ProgressDrawable progressDrawable = new ProgressDrawable();
        progressDrawable.setColor(ContextCompat.getColor(getContext(), R.color.lw013_text_black_4d4d4d));
...
//        }, DIALOG_DISMISS_DELAY_TIME);
    ...
    public int getDialogStyle() {
        return R.style.LW013CenterDialog;
    }
