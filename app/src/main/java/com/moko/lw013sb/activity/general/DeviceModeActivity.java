...
import com.moko.lw013sb.databinding.Lw013ActivityDeviceModeBinding;
...
public class DeviceModeActivity extends BaseActivity {
    ...
    private Lw013ActivityDeviceModeBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw013ActivityDeviceModeBinding.inflate(getLayoutInflater());
        ...
        mBind.tvDeviceMode.postDelayed(() -> {
            LoRaLW013SBMokoSupport.getInstance().sendOrder(OrderTaskAssembler.getDeviceMode());
        }, 500);
    }
    ...
    public void selectDeviceMode(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaLW013SBMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setDeviceMode(value));
        });
