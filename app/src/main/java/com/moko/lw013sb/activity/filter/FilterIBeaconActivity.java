...
import com.moko.lw013sb.databinding.Lw013ActivityFilterIbeaconBinding;
...
public class FilterIBeaconActivity extends BaseActivity {
    ...
    private Lw013ActivityFilterIbeaconBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw013ActivityFilterIbeaconBinding.inflate(getLayoutInflater());
