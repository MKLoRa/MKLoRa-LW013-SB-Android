...
import com.moko.lw013sb.databinding.Lw013DialogChangePasswordBinding;
import com.moko.lw013sb.utils.ToastUtils;


public class ChangePasswordDialog extends BaseDialog<Lw013DialogChangePasswordBinding> {
    ...
    @Override
    protected Lw013DialogChangePasswordBinding getViewBind() {
        return Lw013DialogChangePasswordBinding.inflate(getLayoutInflater());
    }
