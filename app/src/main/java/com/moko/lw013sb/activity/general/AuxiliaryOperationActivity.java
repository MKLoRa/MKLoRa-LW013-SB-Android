...
import com.moko.lw013sb.databinding.Lw013ActivityAuxiliaryOperationBinding;
...
public class AuxiliaryOperationActivity extends BaseActivity {
    ...
    private Lw013ActivityAuxiliaryOperationBinding mBind;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw013ActivityAuxiliaryOperationBinding.inflate(getLayoutInflater());
