...
import com.moko.lw013sb.databinding.Lw013ActivityFilterBxpTagIdBinding;
...
public class FilterBXPTagIdActivity extends BaseActivity {
    ...
    private Lw013ActivityFilterBxpTagIdBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw013ActivityFilterBxpTagIdBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_BXP_TAG_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterBXPTagIdActivity.this).inflate(R.layout.lw013_item_tag_id_filter, mBind.llTagId, false);
