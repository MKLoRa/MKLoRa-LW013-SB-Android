...
import com.moko.lw013sb.databinding.Lw013ActivityFilterOtherBinding;
...
public class FilterOtherActivity extends BaseActivity {
    ...
    private Lw013ActivityFilterOtherBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw013ActivityFilterOtherBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_OTHER_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterOther.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(this).inflate(R.layout.lw013_item_other_filter, mBind.llFilterCondition, false);
