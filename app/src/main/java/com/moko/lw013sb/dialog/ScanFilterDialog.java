...
import com.moko.lw013sb.databinding.Lw013DialogScanFilterBinding;

public class ScanFilterDialog extends com.moko.lw013sb.dialog.BaseDialog<Lw013DialogScanFilterBinding> {
    private int filterRssi;
    private String filterName;

    @Override
    protected Lw013DialogScanFilterBinding getViewBind() {
        return Lw013DialogScanFilterBinding.inflate(getLayoutInflater());
    }
