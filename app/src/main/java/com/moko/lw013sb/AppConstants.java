...
public class AppConstants {
    ...
    public static final String SP_KEY_SAVED_PASSWORD_LW013_SB = "SP_KEY_SAVED_PASSWORD_LW013_SB";
    // extra_key
    // 设备列表\
    ...
    public static final String EXTRA_KEY_ALARM_TYPE = "EXTRA_KEY_ALARM_TYPE";
    // request_code
