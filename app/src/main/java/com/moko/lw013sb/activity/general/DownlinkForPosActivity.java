...
import com.moko.lw013sb.databinding.Lw013ActivityDownlinkForPosBinding;
...
public class DownlinkForPosActivity extends BaseActivity {
    ...
    private Lw013ActivityDownlinkForPosBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw013ActivityDownlinkForPosBinding.inflate(getLayoutInflater());
    ...
    public void selectPosStrategy(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaLW013SBMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setDownLinkPosStrategy(mSelected));
        });
